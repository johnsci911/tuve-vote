		...
		<div class="flex items-center space-x-4 ml-6">		
            ...
            >
				<button
                    @click="isOpen = !isOpen"
                    type="button"
                    class="flex w-36 items-center justify-center h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                >
