                    ...
                    >
                        ...
                        >
							...
							<ul 
                                ...
                                class="absolute z-10 w-44 font-semibold bg-white shadow-dialog rounded-xl py-3 text-left ml-8 top-8 md:top-6 right-0 md:left-0 top-8 md:top-6 right-0 md:left-0"
                            >
	...
	<div class="buttons-container flex items-center justify-between mt-6">	
		<div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">		
            ...
            >
				<button 
                    @click="isOpen = !isOpen"
                    type="button" class="flex items-center w-32 justify-center h-11 text-sm bg-blue font-semibold rounded-xl border border-gray-200 hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white"
                >
					Reply
				</button>
				<div 
                ...
                >
					<form action="#" class="space-y-4 px-4 py-6">
						...
						<div class="flex flex-col md:flex-row items-center md:space-x-3">			
							<button type="button" class="w-full md:w-1/2 flex items-center w-32 justify-center h-11 text-sm bg-blue font-semibold rounded-xl border border-gray-200 hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
								Post Comment	
							</button>
							<button type="button" class="flex items-center justify-center w-full md:w-32 mt-2 md:mt-0 h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
            ...
            >
				<button
                    @click="isOpen = !isOpen"
                    type="button"
                    class="flex w-36 items-center justify-center h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 mt-2 md:mt-0"
                >
