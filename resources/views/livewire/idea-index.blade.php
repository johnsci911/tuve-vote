		...
		<div class="mt-8">
			@if ($hasVoted)
				<button
					...
					class="w-20 bg-blue text-white border border-gray-200 hover:bg-blue-hover transition duration-150 ease-in font-bold text-xxs uppercase rounded-xl px-4 py-3"
				>
					Voted
				</button>
			@else
			...
			<div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
				...
				<div class="flex items-center mt-4 md:hidden md:mt-8">
					...
					@if ($hasVoted)
						<button 
							wire:click.prevent="vote"
							class="w-20 bg-blue text-white border border-gray-200 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in hover:bg-blue-hover px-4 py-3 -mx-5"
						>
							Voted
						</button>
					@else
