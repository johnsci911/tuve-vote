<form wire:submit.prevent="createIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
	...
	<div>				
		<select wire:model.defer="category" id="category_add" name="category_add" class="bg-gray-200 w-full rounded-xl px-4 py-2 border-none text-sm" name="">
	...
	@enderror
	<div>
		<textarea wire:model.defer="description" id="idea" name="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-4 border-none" placeholder="Describe your idea" required></textarea>
		@error('description')
			<p class="text-red text-xs mt-1"> {{ $message }}</p>
		@enderror
	</div>
