...
class IdeaTest extends TestCase
{
     ...
     * @return void
     */
    public function test_voting_for_an_idea_thats_already_voted_for_throw_an_exception()
    {
		$user = User::factory()->create();
		$categoryOne = Category::factory()->create(['name' => 'Category 1']);
		$statusOpen = Status::factory()->create(['name' => 'Open', 'classes' => 'bg-gray-200']);
     ...
     * @return void
     */
    public function test_removing_a_vote_that_doesnt_exist_throw_an_exception()
    {
		$user = User::factory()->create();
		$categoryOne = Category::factory()->create(['name' => 'Category 1']);
		$statusOpen = Status::factory()->create(['name' => 'Open', 'classes' => 'bg-gray-200']);
